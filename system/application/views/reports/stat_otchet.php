...
<td>&nbsp;<?php echo $o->count_odnotarif_1_phase+$o->count_odnotarif_3_phase+$o->count_odnotarif_1_phase_closed+$o->count_odnotarif_3_phase_closed;?></td>
<td>&nbsp;<?php echo $o->count_odnotarif_1_phase+$o->count_odnotarif_3_phase;?></td>
<td>&nbsp;<?php echo $o->count_odnotarif_1_phase+$o->count_odnotarif_3_phase;?></td>
<td>&nbsp;<?php echo $o->count_odnotarif_1_phase-$o->count_mnogotarif_1_phase;?></td>
<td>&nbsp;<?php echo $o->count_odnotarif_3_phase-$o->count_mnogotarif_1_phase-$o->count_mnogotarif_3_phase+$o->count_mnogotarif_1_phase;?></td>
...
<td>&nbsp;<?php echo $sum_odnotarif_1_phase+$sum_odnotarif_3_phase+$sum_odnotarif_1_phase_closed+$sum_odnotarif_3_phase_closed; ?></td>
<td>&nbsp;<?php echo $sum_odnotarif_1_phase+$sum_odnotarif_3_phase;?></td>
<td>&nbsp;<?php echo $sum_odnotarif_1_phase+$sum_odnotarif_3_phase;?></td>
<td>&nbsp;<?php echo $sum_odnotarif_1_phase-$sum_mnogotarif_1_phase;?></td>
<td>&nbsp;<?php echo $sum_odnotarif_3_phase-$sum_mnogotarif_1_phase-$sum_mnogotarif_3_phase+$sum_mnogotarif_1_phase;?></td>
