...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
 ...
 <td rowspan=3 width=110px>По ср. отпускному тарифу (с НДС 21,840)
 </td>
 ...
 <tr align=center>
 <td colspan=2>
  По тарифу дневной (21,840)
 </td>
 <td colspan=2>
  По тарифу ночной (6,780)
 </td>
 <td colspan=2>
  По тарифу вечерний (51,200)
 </td>
 </tr>
 <tr>
 <td >
...
$sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*21.84;
...
$_sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*21.84;
...
<td>
	<?php echo f_d(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*21.84);?>
</td> 

<td>
	<?php echo f_d((($d->tenge_day+$d->tenge_night+$d->tenge_evening)*($d->nds+100)/100)-(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*21.84));?>
</td> 
 ...
 <tr align=center>
<td > Директор филиала ТОО "Солтүстік Энерго Орталық" Тайынша Энерго </td>
