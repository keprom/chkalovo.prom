...
<table width=100%>
    ...
    <tr>
        <td width=2100px> Договор(контракт) на поставку товаров (работ, услуг)
            №<u><?php echo $dogovor . " </u> от <u>" . datetostring($firm->dogovor_date); ?></u></td>
        <td> (3)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td width=2100px> Товарно-транспортная накладная №_______________________ от
    ...
    <tr>
        <td width=2100px> РНН, БИН и адрес местонахождения получателя
