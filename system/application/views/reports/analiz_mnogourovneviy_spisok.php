...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
 ...
 <td rowspan=3 width=110px>По ср. отпускному тарифу (с НДС 14,37)
 </td>
...
$sum_otp_nds+=($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.37;
...
$_sum_otp_nds+=($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.37;
...
<td>
	<?php echo f_d(($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.37);?>
</td> 

<td>
	<?php echo f_d((($d->tenge_ur1+$d->tenge_ur2+$d->tenge_ur3)*($d->nds+100)/100)-(($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.37));?>
</td> 
