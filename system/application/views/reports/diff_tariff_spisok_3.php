...
$sum_sred_kvt=0;$sum_sred_tenge=0;
...
$_sum_sred_kvt=0;$_sum_sred_tenge=0;
...
if ($last_group<>$d->firm_subgroup_id):
	...
	<tr>
	 ...
	 <td align=right>
	  <b><?php echo f_d2($sum_sred_kvt);?></b>
	 </td>
	</tr>
	<?php	
	$sum_day_kvt=0;$sum_day_tenge=0;
...
<td>
	<?php echo f_d2($d->itogo_sred);?>
</td> 
<td>
	<?php echo f_d($d->tenge_sred);?>
</td> 
 ...
 <tr align=center>
<td > Директор ф-ала ТОО "Солтyстiк Энерго Орталык" Тайынша Энерго</td>
