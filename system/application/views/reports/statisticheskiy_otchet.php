...
<td colspan=12 align=center >Счетчиков</td>
</tr>
<tr>
...
$sum_2_tariff=0;
$sum_firm_closed=0;
$sum_1_phase_closed=0;
$sum_3_phase_closed=0;
$sum_2_tariff_closed=0;
...
$sum_1_phase_closed+=$o->count_1_phase_closed;
$sum_3_phase_closed+=$o->count_3_phase_closed;
$sum_2_tariff_closed+=$o->count_2_tariff_closed;
?>
<tr>
...
<td>&nbsp;<?php echo $o->count_1_phase+$o->count_3_phase+$o->count_1_phase_closed+$o->count_3_phase_closed;?></td>
<td>&nbsp;<?php echo $o->count_1_phase+$o->count_3_phase;?></td>
<td>&nbsp;<?php echo $o->count_1_phase+$o->count_3_phase;?></td>
<td>&nbsp;<?php echo $o->count_1_phase;?></td>
<td>&nbsp;<?php echo $o->count_1_phase+$o->count_3_phase-$o->count_1_phase;?></td>
<td>&nbsp;<?php echo $o->count_2_tariff;?></td>


<td>&nbsp;<?php echo $o->count_1_phase_closed+$o->count_3_phase_closed;?></td>
<td>&nbsp;<?php echo $o->count_1_phase_closed+$o->count_3_phase_closed;?></td>
<td>&nbsp;<?php echo $o->count_1_phase_closed;?></td>
<td>&nbsp;<?php echo $o->count_1_phase_closed+$o->count_3_phase_closed-$o->count_1_phase_closed;?></td>
<td>&nbsp;<?php echo $o->count_2_tariff_closed;?></td>
...
<td>&nbsp;<?php echo $sum_1_phase+$sum_3_phase+$sum_1_phase_closed+$sum_3_phase_closed; ?></td>
<td>&nbsp;<?php echo $sum_1_phase+$sum_3_phase;?></td>
<td>&nbsp;<?php echo $sum_1_phase+$sum_3_phase;?></td>
<td>&nbsp;<?php echo $sum_1_phase;?></td>
<td>&nbsp;<?php echo $sum_1_phase+$sum_3_phase-$sum_1_phase;?></td>
<td>&nbsp;<?php echo $sum_2_tariff;?></td>

<td>&nbsp;<?php echo $sum_1_phase_closed+$sum_3_phase_closed;?></td>
<td>&nbsp;<?php echo $sum_1_phase_closed+$sum_3_phase_closed;?></td>
<td>&nbsp;<?php echo $sum_1_phase_closed;?></td>
<td>&nbsp;<?php echo $sum_1_phase_closed+$sum_3_phase_closed-$sum_1_phase_closed;?></td>
<td>&nbsp;<?php echo $sum_2_tariff_closed;?></td>
</tr>
</table>
